...
import logo from "../../../public/logo.png"; // Replace with your logo image path
...
const InvoicePage = () => {
  ...
  return (
    <div className="max-w-lg  h-[100%] mx-auto p-4 border rounded shadow-md mt-8">
      ...
      <div>
        <img src="https://img.freepik.com/free-photo/3d-payment-terminal-bank-card-blue-checkmark_107791-17014.jpg?w=826&t=st=1718786240~exp=1718786840~hmac=897866cae02784eaa3f2e4f3c22aead1bbccd256ef92772aa6456b608aeb69e7" alt="" />
      </div>
    </div>
  );
};
