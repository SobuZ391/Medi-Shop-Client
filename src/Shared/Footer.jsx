...
const Footer = () => {
    return (
        <footer className="px-4 mt-6 divide-y border-y-2 rounded-lg  ">
	<div className=" flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 container">
